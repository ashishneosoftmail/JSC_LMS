...
namespace JSC_LSM.UI.Controllers
{
    ...
    public class PrincipalController : BaseController
    {
        ...
        public PrincipalController(JSC_LSM.UI.Common.Common common, ISchoolRepository schoolRepository, IPrincipalRepository principalRepository, ICircularRepository circularRepository, IConfiguration configuration, IWebHostEnvironment webHostEnvironment)
        {
