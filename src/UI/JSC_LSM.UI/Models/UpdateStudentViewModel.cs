...
namespace JSC_LSM.UI.Models
{
    public class UpdateStudentViewModel: UpdateStudentDto
    {
        ...
        [Remote("CheckEmailExistsForUpdateStudent", "User", HttpMethod = "POST", ErrorMessage = "EmailId already exists in database.")]

        public string EmailId { get; set; }
        [StringLength(100, ErrorMessage = "Username should not be more than 100 characters")]
        [Required(ErrorMessage = "Username is mandatory")]
        [Remote("CheckUsernameExistsForUpdateStudent", "User", HttpMethod = "POST", ErrorMessage = "UserName already exists in database.")]
