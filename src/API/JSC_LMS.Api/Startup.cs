using JSC_LMS.Api.Extensions;
using JSC_LMS.Api.Middleware;
using JSC_LMS.Api.Services;
using JSC_LMS.Api.SwaggerHelper;
using JSC_LMS.Api.Utility;
using JSC_LMS.Application;
using JSC_LMS.Application.Contracts;
using JSC_LMS.Identity;
using JSC_LMS.Infrastructure;
