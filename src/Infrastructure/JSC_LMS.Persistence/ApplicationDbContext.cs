using JSC_LMS.Application.Contracts;
            ...
            foreach (var entry in ChangeTracker.Entries<AuditableEntity>())
            {
                switch (entry.State)
                {
                    case EntityState.Added:
                        ...
                        entry.Entity.CreatedBy = Convert.ToInt32(_loggedInUserService.UserId);
                        break;
                    case EntityState.Modified:
                        entry.Entity.LastModifiedDate = DateTime.Now;
                        entry.Entity.LastModifiedBy = Convert.ToInt32(_loggedInUserService.UserId);
                        break;
                    case EntityState.Deleted:
                        entry.Entity.DeletedDate = DateTime.Now;
                        entry.Entity.DeletedBy = Convert.ToInt32(_loggedInUserService.UserId);
                        break;
                }
            }
